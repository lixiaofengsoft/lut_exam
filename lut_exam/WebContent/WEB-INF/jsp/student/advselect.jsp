	...
	<body>
		<c:import url="header.jsp"></c:import>
				...
				<table class="table table-bordered" style="width: 1000px" align="center">
					...
					<tr>
						<td colspan="2"  align="center"><input class="btn btn-default" type="button" value="返回" onclick="window.location.href='student/advice'"></td>
					</tr>
				</table>
<%-- 				<form action="manager/addAdviceMsg" method="post">
					...
					<br>
					 添加时间：
					 		<span><fmt:formatDate value="${advice.createtime }" pattern="yyyy-MM-dd"/></span>	
					 <input type="button" value="返回" onclick="window.location.href='student/advice'">
				</form>		 --%>			
